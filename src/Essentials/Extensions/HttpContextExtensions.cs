...
namespace Essentials.Extensions
{
    ...
    public static class HttpContextExtensions
    {
        ...
        {
            string urlSeparator = relativeUrl?.StartsWith("/") ?? false ? string.Empty : "/";
            return $"{httpContext.Request.Scheme}://{httpContext.Request.Host}{urlSeparator}{relativeUrl ?? string.Empty}";
        }
        ...
        public static object GetRouteValueOrDefault(this HttpContext httpContext, string routeValueKey)
        {
            httpContext
                .GetRouteData()
                .Values
                .TryGetValue(routeValueKey, out var routeValueObject);
